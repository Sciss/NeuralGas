...
public class ListGNG {
     ...
     * @param elem The element to be inserted.
     */
    public void PQ_insert(HalfEdgeVoronoi elem) {
     ...
     */
    public void PQ_delete(HalfEdgeVoronoi elem) {
        // Find the right position
        ListElem p;
        p = find(elem);
    ...
    public PointFloat2D PQ_min() {
        ListElem p = first();
        PointFloat2D fp = new PointFloat2D(p.elem.vertex.coord.x, p.elem.yStar);
        return (fp);
    }
