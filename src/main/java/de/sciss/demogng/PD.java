...
interface PD {
    ...
    void draw(PanelGNG panel, Graphics g, Dimension d);
    ...
    final class Rectangle implements PD {
        ...
        public void getSignal(ComputeGNG compute) {
            ...
            compute.SignalX = (int) (ll + (r2 * Math.random()));
            compute.SignalY = (int) (lr + (l2 * Math.random()));
        }

        @Override
        public void draw(final PanelGNG panel, final Graphics g, final Dimension d) {
    ...
    final class UNI implements PD {
        ...
        public void getSignal(ComputeGNG compute) {
            ...
            final int z = (int) (14 * Math.random());
            compute.SignalX = (int) (xA[z] + (w * Math.random()));
            compute.SignalY = (int) (yA[z] + (h * Math.random()));
        }
    ...
    final class SmallSpirals implements PD {
        ...
        public void getSignal(ComputeGNG compute) {
            ...
            final int z = (int) (22 * Math.random());
            compute.SignalX = (int) (xA[z] + (w * Math.random()));
            compute.SignalY = (int) (yA[z] + (h * Math.random()));
        }
    ...
    final class LargeSpirals implements PD {
        ...
        public void getSignal(ComputeGNG compute) {
            ...
            final int z = (int) (58 * Math.random());
            compute.SignalX = (int) (xA[z] + (w * Math.random()));
            compute.SignalY = (int) (yA[z] + (h * Math.random()));
        }
    ...
    final class HiLoDensity implements PD {
        ...
        public void getSignal(ComputeGNG compute) {
            ...
            final int z = (int) (2 * Math.random());
            if (z == 0) {
                compute.SignalX = (int) (xA[z] + (w * Math.random()));
                compute.SignalY = (int) (yA[z] + (h * Math.random()));
            } else {
                compute.SignalX = (int) (xA[z] + (4 * w * Math.random()));
                compute.SignalY = (int) (yA[z] + (8 * h * Math.random()));
            }
        }
        ...
        public void draw(final PanelGNG panel, final Graphics g, final Dimension d) {
            ...
            final Algorithm algorithm = panel.compute.algorithm;
            if (!algorithm.isDiscrete())
                g.setColor(panel.highDistribColor);
            g.fillRect(xA[0], yA[0], w, h);
            if (!algorithm.isDiscrete())
                g.setColor(panel.lowDistribColor);
    ...
    final class DiscreteMixture implements PD {
        ...
        @Override
        public void getSignal(ComputeGNG compute) {
            final int z = (int) (compute.MIXTURE_SIZE * Math.random());
        ...
        public void draw(final PanelGNG panel, final Graphics g, final Dimension d) {
            //int RADIUS = 2;
            final ComputeGNG compute = panel.compute;
    ...
    final class UNIT implements PD {
        ...
        public void getSignal(ComputeGNG compute) {
            ...
            final int z = (int) (28 * Math.random());
            compute.SignalX = (int) (xA[z] + (w * Math.random()));
            compute.SignalY = (int) (yA[z] + (h * Math.random()));
        }
    ...
    final class MoveJump implements PD {
        ...
        public void draw(final PanelGNG panel, final Graphics g, final Dimension d) {
            ...
            final int ns0 = panel.compute.numSignals;
    ...
    final class Jump implements PD {
        ...
        public void getSignal(ComputeGNG compute) {
            ...
            if (Math.ceil(Math.IEEEremainder(compute.numSignals, 1000.0)) == 0) {
                compute.jumpX = (int) ((wi - r2) * Math.random());
                compute.jumpY = (int) ((hi - l2) * Math.random());
            }

            compute.SignalX = (int) (compute.jumpX + (r2 * Math.random()));
            compute.SignalY = (int) (compute.jumpY + (l2 * Math.random()));
        }
